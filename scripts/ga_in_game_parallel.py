# ga_in_game.py — FINAL: EVOLVES + SAVES FRAMES + PERFECT LINES + MPI PARALLEL
...
rank = comm.Get_rank()
size = comm.Get_size()
SEGMENT_ID = rank  # Ranks 0-16 for segments 0-16
...
class GAInGame:
    ...
    def update(self):
        ...
        if not self.headless and time.time() - getattr(self, "last_time", 0) < 3.0:
            return
...
if __name__ == "__main__":
    ...
    ga = GAInGame(car)
    ga.headless = True  # Run headless for MPI parallel execution
